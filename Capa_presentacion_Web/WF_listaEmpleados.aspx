<%@ Page Title="" Language="C#" MasterPageFile="~/plantilla.Master" AutoEventWireup="true" CodeBehind="WF_listaEmpleados.aspx.cs" Inherits="Capa_presentacion_Web.WF_listaEmpleados" %>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <asp:GridView ID="dgEmpleados" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="dgEmpleados_SelectedIndexChanged">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="IdRolEmpleado" HeaderText="Rol" />
            <asp:BoundField DataField="strDatosAdicionales" HeaderText="DatosAdicionales" />
